...
namespace UniFFIScaffolding {
  ...
  //
  // This is called by the JS code before lowing a callback interface object.  The returned handle
  ...
  // reference count.  If `0`, then the map entry for the JS ojbect is removed.
