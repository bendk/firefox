...
/**
 * Increase the refconut for a callback interface handle.  Returns the new refcount.
 */
uint32_t CallbackHandleAddRef(uint64_t aHandle);

/**
 * Decrease the refconut for a callback interface handle.  Returns the new refcount.
 */
