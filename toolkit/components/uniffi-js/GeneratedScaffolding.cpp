...
#ifdef MOZ_UNIFFI_FIXTURES
class ForeignFutureHandlerVoid final : public PromiseNativeHandler {
public:
  NS_DECL_ISUPPORTS

private:
  ForeignFutureCompletevoid mCompleteHandler;
  uint64_t mCallbackData;

public:
  ForeignFutureHandlerVoid(
  ...
  virtual void ResolvedCallback(JSContext* aCx, JS::Handle<JS::Value> aValue,
    ...
    if (!callResult.Init(aCx, aValue)) {
      MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerVoid] callback method did not return a UniFFIScaffoldingCallResult"));
    ...
    switch (callResult.mCode) {
      ...
      case UniFFIScaffoldingCallCode::Error: {
        ...
        if (!callResult.mData.WasPassed()) {
          MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerVoid] No data passed"));
        ...
        if (error.Failed()) {
          MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerVoid] Failed to lower error buffer"));
          result.call_status.code = RUST_CALL_INTERNAL_ERROR;
        } else {
  ...
  virtual void RejectedCallback(JSContext* aCx, JS::Handle<JS::Value> aValue,
                                ErrorResult& aRv) override {
    MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerVoid] promise rejected"));
    MOZ_ASSERT(mCompleteHandler);
    ForeignFutureResultvoid result{};
    result.call_status.code = RUST_CALL_INTERNAL_ERROR;
    mCompleteHandler(mCallbackData, result);
...
protected:
  ~ForeignFutureHandlerVoid() {
    if (mCompleteHandler) {
      MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerVoid] promise never completed"));
      ForeignFutureResultvoid result{};
      result.call_status.code = RUST_CALL_INTERNAL_ERROR;
      mCompleteHandler(mCallbackData, result);
    }
...
NS_IMPL_ISUPPORTS0(ForeignFutureHandlerVoid);
class ForeignFutureHandlerUInt32 final : public PromiseNativeHandler {
public:
  NS_DECL_ISUPPORTS

private:
  ForeignFutureCompleteu32 mCompleteHandler;
  uint64_t mCallbackData;

public:
  ForeignFutureHandlerUInt32(
  ...
  virtual void ResolvedCallback(JSContext* aCx, JS::Handle<JS::Value> aValue,
    ...
    RootedDictionary<UniFFIScaffoldingCallResult> callResult(aCx);
    if (!callResult.Init(aCx, aValue)) {
      MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerUInt32] callback method did not return a UniFFIScaffoldingCallResult"));
      callResult.mCode = UniFFIScaffoldingCallCode::Internal_error;
    }
    ...
    switch (callResult.mCode) {
      case UniFFIScaffoldingCallCode::Success: {
        ...
        if (!callResult.mData.WasPassed()) {
          MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerUInt32] No data passed"));
          result.call_status.code = RUST_CALL_INTERNAL_ERROR;
          break;
        }
        ErrorResult error;
        ...
        if (error.Failed()) {
          MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerUInt32] Failed to lower return value"));
          result.call_status.code = RUST_CALL_INTERNAL_ERROR;
        } else {
      ...
      case UniFFIScaffoldingCallCode::Error: {
        ...
        errorBuf.Lower(callResult.mData.Value(), error);
        if (error.Failed()) {
          MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerUInt32] Failed to lower error buffer"));
          result.call_status.code = RUST_CALL_INTERNAL_ERROR;
        } else {
          result.call_status.error_buf = errorBuf.IntoRust();
        }
  ...
  virtual void RejectedCallback(JSContext* aCx, JS::Handle<JS::Value> aValue,
                                ErrorResult& aRv) override {
    MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerUInt32] promise rejected"));
    MOZ_ASSERT(mCompleteHandler);
    ForeignFutureResultu32 result{};
    result.call_status.code = RUST_CALL_INTERNAL_ERROR;
    mCompleteHandler(mCallbackData, result);
...
protected:
  ~ForeignFutureHandlerUInt32() {
    if (mCompleteHandler) {
      MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerUInt32] promise never completed"));
      ForeignFutureResultu32 result{};
      result.call_status.code = RUST_CALL_INTERNAL_ERROR;
      mCompleteHandler(mCallbackData, result);
    }
...
NS_IMPL_ISUPPORTS0(ForeignFutureHandlerUInt32);
class ForeignFutureHandlerRustBuffer final : public PromiseNativeHandler {
public:
  NS_DECL_ISUPPORTS

private:
  ForeignFutureCompleterust_buffer mCompleteHandler;
  uint64_t mCallbackData;

public:
  ForeignFutureHandlerRustBuffer(
  ...
  virtual void ResolvedCallback(JSContext* aCx, JS::Handle<JS::Value> aValue,
    ...
    RootedDictionary<UniFFIScaffoldingCallResult> callResult(aCx);
    if (!callResult.Init(aCx, aValue)) {
      MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerRustBuffer] callback method did not return a UniFFIScaffoldingCallResult"));
      callResult.mCode = UniFFIScaffoldingCallCode::Internal_error;
    }
    ...
    switch (callResult.mCode) {
      case UniFFIScaffoldingCallCode::Success: {
        ...
        if (!callResult.mData.WasPassed()) {
          MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerRustBuffer] No data passed"));
          result.call_status.code = RUST_CALL_INTERNAL_ERROR;
          break;
        }
        ErrorResult error;
        ...
        returnValue.Lower(callResult.mData.Value(), error);
        if (error.Failed()) {
          MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerRustBuffer] Failed to lower return value"));
          result.call_status.code = RUST_CALL_INTERNAL_ERROR;
        } else {
          result.return_value = returnValue.IntoRust();
        }
      ...
      case UniFFIScaffoldingCallCode::Error: {
        ...
        errorBuf.Lower(callResult.mData.Value(), error);
        if (error.Failed()) {
          MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerRustBuffer] Failed to lower error buffer"));
          result.call_status.code = RUST_CALL_INTERNAL_ERROR;
        } else {
          result.call_status.error_buf = errorBuf.IntoRust();
        }
  ...
  virtual void RejectedCallback(JSContext* aCx, JS::Handle<JS::Value> aValue,
                                ErrorResult& aRv) override {
    MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerRustBuffer] promise rejected"));
    MOZ_ASSERT(mCompleteHandler);
    ForeignFutureResultrust_buffer result{};
    result.call_status.code = RUST_CALL_INTERNAL_ERROR;
    mCompleteHandler(mCallbackData, result);
...
protected:
  ~ForeignFutureHandlerRustBuffer() {
    if (mCompleteHandler) {
      MOZ_LOG(gUniffiLogger, LogLevel::Error, ("[ForeignFutureHandlerRustBuffer] promise never completed"));
      ForeignFutureResultrust_buffer result{};
      result.call_status.code = RUST_CALL_INTERNAL_ERROR;
      mCompleteHandler(mCallbackData, result);
    }
...
NS_IMPL_ISUPPORTS0(ForeignFutureHandlerRustBuffer);
#endif /* MOZ_UNIFFI_FIXTURES */
...
public:
  CallbackInterfaceMethodErrorsupportApplicationErrorReporterReportError(
      uint64_t aUniffiHandle, RustBuffer aTypeName, RustBuffer aMessage)
...
extern "C" void callback_interface_errorsupport_application_error_reporter_report_error(
  ...
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerApplicationErrorReporter);
}
...
public:
  CallbackInterfaceMethodErrorsupportApplicationErrorReporterReportBreadcrumb(
      uint64_t aUniffiHandle, RustBuffer aMessage, RustBuffer aModule, uint32_t aLine, uint32_t aColumn)
...
extern "C" void callback_free_errorsupport_application_error_reporter(uint64_t uniffiHandle) {
  ...
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(MakeUnique<UniffiCallbackFreeHandler>("ApplicationErrorReporter", uniffiHandle), &gUniffiCallbackHandlerApplicationErrorReporter);
}
...
#ifdef MOZ_UNIFFI_FIXTURES
static StaticRefPtr<dom::UniFFICallbackHandler> gUniffiCallbackHandlerTestAsyncCallbackInterface;

class CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceNoop : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
...
public:
  CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceNoop(
      uint64_t aUniffiHandle, RefPtr<PromiseNativeHandler> aPromiseCompleteHandler)
    : UniffiCallbackMethodHandlerBase("TestAsyncCallbackInterface", aUniffiHandle), mPromiseCompleteHandler(aPromiseCompleteHandler){
  }
...
extern "C" void callback_interface_uniffi_bindings_tests_test_async_callback_interface_noop(
  ...
  // the Rust callback.
  RefPtr<PromiseNativeHandler> promiseCompleteHandler = new ForeignFutureHandlerVoid(aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceNoop>(aUniffiHandle, promiseCompleteHandler);
  // Now that everything is set up, schedule the call in the JS main thread.
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerTestAsyncCallbackInterface);
}

class CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceGetValue : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
  RefPtr<PromiseNativeHandler> mPromiseCompleteHandler;
...
extern "C" void callback_interface_uniffi_bindings_tests_test_async_callback_interface_get_value(
  ...
  // Create a `PromiseNativeHandler` that will complete the promise by calling
  // the Rust callback.
  RefPtr<PromiseNativeHandler> promiseCompleteHandler = new ForeignFutureHandlerUInt32(aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceGetValue>(aUniffiHandle, promiseCompleteHandler);
  // Now that everything is set up, schedule the call in the JS main thread.
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerTestAsyncCallbackInterface);
}

class CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceSetValue : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueInt<uint32_t> mValue{};
  RefPtr<PromiseNativeHandler> mPromiseCompleteHandler;
...
public:
  CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceSetValue(
      uint64_t aUniffiHandle, uint32_t aValue, RefPtr<PromiseNativeHandler> aPromiseCompleteHandler)
    : UniffiCallbackMethodHandlerBase("TestAsyncCallbackInterface", aUniffiHandle), mValue(FfiValueInt<uint32_t>::FromRust(aValue)), mPromiseCompleteHandler(aPromiseCompleteHandler){
  }
...
extern "C" void callback_interface_uniffi_bindings_tests_test_async_callback_interface_set_value(
  ...
  // the Rust callback.
  RefPtr<PromiseNativeHandler> promiseCompleteHandler = new ForeignFutureHandlerVoid(aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceSetValue>(aUniffiHandle, aValue, promiseCompleteHandler);
  // Now that everything is set up, schedule the call in the JS main thread.
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerTestAsyncCallbackInterface);
}

class CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceThrowIfEqual : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueRustBuffer mNumbers{};
  RefPtr<PromiseNativeHandler> mPromiseCompleteHandler;
...
public:
  CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceThrowIfEqual(
      uint64_t aUniffiHandle, RustBuffer aNumbers, RefPtr<PromiseNativeHandler> aPromiseCompleteHandler)
    : UniffiCallbackMethodHandlerBase("TestAsyncCallbackInterface", aUniffiHandle), mNumbers(FfiValueRustBuffer::FromRust(aNumbers)), mPromiseCompleteHandler(aPromiseCompleteHandler){
  }
...
extern "C" void callback_interface_uniffi_bindings_tests_test_async_callback_interface_throw_if_equal(
  ...
  // Create a `PromiseNativeHandler` that will complete the promise by calling
  // the Rust callback.
  RefPtr<PromiseNativeHandler> promiseCompleteHandler = new ForeignFutureHandlerRustBuffer(aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceThrowIfEqual>(aUniffiHandle, aNumbers, promiseCompleteHandler);
  // Now that everything is set up, schedule the call in the JS main thread.
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerTestAsyncCallbackInterface);
}
...
extern "C" void callback_free_uniffi_bindings_tests_test_async_callback_interface(uint64_t uniffiHandle) {
  // Callback object handles are keys in a map stored in the JS handler. To
  // handle the free call, schedule a JS call to remove the key.
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(MakeUnique<UniffiCallbackFreeHandler>("TestAsyncCallbackInterface", uniffiHandle), &gUniffiCallbackHandlerTestAsyncCallbackInterface);
}
...
class CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceNoop : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
...
extern "C" void callback_interface_uniffi_bindings_tests_test_callback_interface_noop(
  ...
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceNoop>(aUniffiHandle);
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerTestCallbackInterface);
}
...
class CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceSetValue : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueInt<uint32_t> mValue{};
...
public:
  CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceSetValue(
      uint64_t aUniffiHandle, uint32_t aValue)
    : UniffiCallbackMethodHandlerBase("TestCallbackInterface", aUniffiHandle), mValue(FfiValueInt<uint32_t>::FromRust(aValue)){
  }
  ...
  void MakeCall(JSContext* aCx, dom::UniFFICallbackHandler* aJsHandler, ErrorResult& aError) override {
    ...
    NullableRootedUnion<dom::OwningUniFFIScaffoldingValue> returnValue(aCx);
    // Make the call
    aJsHandler->Call(mUniffiHandle.IntoRust(), 2, uniffiArgs, returnValue, aError);
  }
};
...
extern "C" void callback_interface_uniffi_bindings_tests_test_callback_interface_set_value(
  ...
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceSetValue>(aUniffiHandle, aValue);
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerTestCallbackInterface);
}


class CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceThrowIfEqual : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueRustBuffer mNumbers{};
...
public:
  CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceThrowIfEqual(
      uint64_t aUniffiHandle, RustBuffer aNumbers)
    : UniffiCallbackMethodHandlerBase("TestCallbackInterface", aUniffiHandle), mNumbers(FfiValueRustBuffer::FromRust(aNumbers)){
  }
  ...
  void MakeCall(JSContext* aCx, dom::UniFFICallbackHandler* aJsHandler, ErrorResult& aError) override {
    ...
    NullableRootedUnion<dom::OwningUniFFIScaffoldingValue> returnValue(aCx);
    // Make the call
    aJsHandler->Call(mUniffiHandle.IntoRust(), 3, uniffiArgs, returnValue, aError);
  }
};
...
extern "C" void callback_interface_uniffi_bindings_tests_test_callback_interface_throw_if_equal(
  ...
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceThrowIfEqual>(aUniffiHandle, aNumbers);
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerTestCallbackInterface);
}
...
extern "C" void callback_free_uniffi_bindings_tests_test_callback_interface(uint64_t uniffiHandle) {
  // Callback object handles are keys in a map stored in the JS handler. To
  // handle the free call, schedule a JS call to remove the key.
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(MakeUnique<UniffiCallbackFreeHandler>("TestCallbackInterface", uniffiHandle), &gUniffiCallbackHandlerTestCallbackInterface);
}
...
static StaticRefPtr<dom::UniFFICallbackHandler> gUniffiCallbackHandlerAsyncTestTraitInterface;

class CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceNoop : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
  RefPtr<PromiseNativeHandler> mPromiseCompleteHandler;
...
public:
  CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceNoop(
      uint64_t aUniffiHandle, RefPtr<PromiseNativeHandler> aPromiseCompleteHandler)
    : UniffiCallbackMethodHandlerBase("AsyncTestTraitInterface", aUniffiHandle), mPromiseCompleteHandler(aPromiseCompleteHandler){
  }
...
extern "C" void callback_interface_uniffi_bindings_tests_async_test_trait_interface_noop(
  ...
  // the Rust callback.
  RefPtr<PromiseNativeHandler> promiseCompleteHandler = new ForeignFutureHandlerVoid(aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceNoop>(aUniffiHandle, promiseCompleteHandler);
  // Now that everything is set up, schedule the call in the JS main thread.
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerAsyncTestTraitInterface);
}

class CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceGetValue : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
  RefPtr<PromiseNativeHandler> mPromiseCompleteHandler;
...
extern "C" void callback_interface_uniffi_bindings_tests_async_test_trait_interface_get_value(
  ...
  // the Rust callback.
  RefPtr<PromiseNativeHandler> promiseCompleteHandler = new ForeignFutureHandlerUInt32(aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceGetValue>(aUniffiHandle, promiseCompleteHandler);
  // Now that everything is set up, schedule the call in the JS main thread.
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerAsyncTestTraitInterface);
}

class CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceSetValue : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueInt<uint32_t> mValue{};
  RefPtr<PromiseNativeHandler> mPromiseCompleteHandler;
...
public:
  CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceSetValue(
      uint64_t aUniffiHandle, uint32_t aValue, RefPtr<PromiseNativeHandler> aPromiseCompleteHandler)
    : UniffiCallbackMethodHandlerBase("AsyncTestTraitInterface", aUniffiHandle), mValue(FfiValueInt<uint32_t>::FromRust(aValue)), mPromiseCompleteHandler(aPromiseCompleteHandler){
  }
...
extern "C" void callback_interface_uniffi_bindings_tests_async_test_trait_interface_set_value(
  ...
  // the Rust callback.
  RefPtr<PromiseNativeHandler> promiseCompleteHandler = new ForeignFutureHandlerVoid(aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceSetValue>(aUniffiHandle, aValue, promiseCompleteHandler);
  // Now that everything is set up, schedule the call in the JS main thread.
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerAsyncTestTraitInterface);
}

class CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceThrowIfEqual : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueRustBuffer mNumbers{};
  RefPtr<PromiseNativeHandler> mPromiseCompleteHandler;
...
public:
  CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceThrowIfEqual(
      uint64_t aUniffiHandle, RustBuffer aNumbers, RefPtr<PromiseNativeHandler> aPromiseCompleteHandler)
    : UniffiCallbackMethodHandlerBase("AsyncTestTraitInterface", aUniffiHandle), mNumbers(FfiValueRustBuffer::FromRust(aNumbers)), mPromiseCompleteHandler(aPromiseCompleteHandler){
  }
...
extern "C" void callback_interface_uniffi_bindings_tests_async_test_trait_interface_throw_if_equal(
  ...
  // the Rust callback.
  RefPtr<PromiseNativeHandler> promiseCompleteHandler = new ForeignFutureHandlerRustBuffer(aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceThrowIfEqual>(aUniffiHandle, aNumbers, promiseCompleteHandler);
  // Now that everything is set up, schedule the call in the JS main thread.
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerAsyncTestTraitInterface);
}
...
extern "C" void callback_free_uniffi_bindings_tests_async_test_trait_interface(uint64_t uniffiHandle) {
  // Callback object handles are keys in a map stored in the JS handler. To
  // handle the free call, schedule a JS call to remove the key.
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(MakeUnique<UniffiCallbackFreeHandler>("AsyncTestTraitInterface", uniffiHandle), &gUniffiCallbackHandlerAsyncTestTraitInterface);
}
...
static StaticRefPtr<dom::UniFFICallbackHandler> gUniffiCallbackHandlerTestTraitInterface;

class CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceNoop : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
...
public:
  CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceNoop(
      uint64_t aUniffiHandle)
    : UniffiCallbackMethodHandlerBase("TestTraitInterface", aUniffiHandle){
  }
...
extern "C" void callback_interface_uniffi_bindings_tests_test_trait_interface_noop(
  ...
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceNoop>(aUniffiHandle);
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerTestTraitInterface);
}


class CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceGetValue : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
...
extern "C" void callback_interface_uniffi_bindings_tests_test_trait_interface_get_value(
  ...
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceGetValue>(aUniffiHandle);
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerTestTraitInterface);
}


class CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceSetValue : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueInt<uint32_t> mValue{};
...
public:
  CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceSetValue(
      uint64_t aUniffiHandle, uint32_t aValue)
    : UniffiCallbackMethodHandlerBase("TestTraitInterface", aUniffiHandle), mValue(FfiValueInt<uint32_t>::FromRust(aValue)){
  }
...
extern "C" void callback_interface_uniffi_bindings_tests_test_trait_interface_set_value(
  ...
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceSetValue>(aUniffiHandle, aValue);
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerTestTraitInterface);
}


class CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceThrowIfEqual : public UniffiCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueRustBuffer mNumbers{};
...
public:
  CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceThrowIfEqual(
      uint64_t aUniffiHandle, RustBuffer aNumbers)
    : UniffiCallbackMethodHandlerBase("TestTraitInterface", aUniffiHandle), mNumbers(FfiValueRustBuffer::FromRust(aNumbers)){
  }
...
extern "C" void callback_interface_uniffi_bindings_tests_test_trait_interface_throw_if_equal(
  ...
  UniquePtr<UniffiCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceThrowIfEqual>(aUniffiHandle, aNumbers);
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(std::move(handler), &gUniffiCallbackHandlerTestTraitInterface);
}
...
extern "C" void callback_free_uniffi_bindings_tests_test_trait_interface(uint64_t uniffiHandle) {
  // Callback object handles are keys in a map stored in the JS handler. To
  // handle the free call, schedule a JS call to remove the key.
  UniffiCallbackMethodHandlerBase::ScheduleMakeCall(MakeUnique<UniffiCallbackFreeHandler>("TestTraitInterface", uniffiHandle), &gUniffiCallbackHandlerTestTraitInterface);
}
...
void RegisterCallbackHandler(uint64_t aInterfaceId, UniFFICallbackHandler& aCallbackHandler, ErrorResult& aError) {
  switch (aInterfaceId) {
    ...
    #ifdef MOZ_UNIFFI_FIXTURES
    case 2: {
      if (gUniffiCallbackHandlerTestAsyncCallbackInterface) {
        aError.ThrowUnknownError("[UniFFI] Callback handler already registered for TestAsyncCallbackInterface"_ns);
        return;
      }

      gUniffiCallbackHandlerTestAsyncCallbackInterface = &aCallbackHandler;
      uniffi_uniffi_bindings_tests_fn_init_callback_vtable_testasynccallbackinterface(&kUniffiVtableTestAsyncCallbackInterface);
      break;
    }
    case 3: {
    ...
    case 4: {
      if (gUniffiCallbackHandlerAsyncTestTraitInterface) {
        aError.ThrowUnknownError("[UniFFI] Callback handler already registered for AsyncTestTraitInterface"_ns);
        return;
      }

      gUniffiCallbackHandlerAsyncTestTraitInterface = &aCallbackHandler;
      uniffi_uniffi_bindings_tests_fn_init_callback_vtable_asynctesttraitinterface(&kUniffiVtableAsyncTestTraitInterface);
      break;
    }
    case 5: {
      if (gUniffiCallbackHandlerTestTraitInterface) {
        aError.ThrowUnknownError("[UniFFI] Callback handler already registered for TestTraitInterface"_ns);
        return;
      }

      gUniffiCallbackHandlerTestTraitInterface = &aCallbackHandler;
      uniffi_uniffi_bindings_tests_fn_init_callback_vtable_testtraitinterface(&kUniffiVtableTestTraitInterface);
      break;
    }
    #endif /* MOZ_UNIFFI_FIXTURES */
...
void DeregisterCallbackHandler(uint64_t aInterfaceId, ErrorResult& aError) {
  switch (aInterfaceId) {
    ...
    case 2: {
      ...
      gUniffiCallbackHandlerTestAsyncCallbackInterface = nullptr;
      break;
    }
    case 3: {
      if (!gUniffiCallbackHandlerTestCallbackInterface) {
    ...
    case 4: {
      ...
      gUniffiCallbackHandlerAsyncTestTraitInterface = nullptr;
      break;
    }
    case 5: {
      if (!gUniffiCallbackHandlerTestTraitInterface) {
      ...
      gUniffiCallbackHandlerTestTraitInterface = nullptr;
      break;
    }
    #endif /* MOZ_UNIFFI_FIXTURES */
