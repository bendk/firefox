...
class CallbackInterfaceMethodContextIdContextIdCallbackPersist final : public FireAndForgetCallbackMethodHandlerBase {
private:
  // Rust arguments
...
public:
  CallbackInterfaceMethodContextIdContextIdCallbackPersist(
    ...
    : FireAndForgetCallbackMethodHandlerBase(
...
extern "C" void callback_interface_context_id_context_id_callback_persist(
  ...
  UniquePtr<FireAndForgetCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodContextIdContextIdCallbackPersist>(aUniffiHandle, aContextId, aCreationDate);
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(std::move(handler), &gUniffiCallbackHandlerContextIdCallback);
}


class CallbackInterfaceMethodContextIdContextIdCallbackRotated final : public FireAndForgetCallbackMethodHandlerBase {
private:
  // Rust arguments
...
extern "C" void callback_interface_context_id_context_id_callback_rotated(
  ...
  UniquePtr<FireAndForgetCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodContextIdContextIdCallbackRotated>(aUniffiHandle, aOldContextId);
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(std::move(handler), &gUniffiCallbackHandlerContextIdCallback);
}
...
extern "C" void callback_free_context_id_context_id_callback(uint64_t uniffiHandle) {
  ...
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(MakeUnique<CallbackFreeHandler>("ContextIdCallback.uniffi_free", uniffiHandle), &gUniffiCallbackHandlerContextIdCallback);
}
...
class CallbackInterfaceMethodErrorsupportApplicationErrorReporterReportError final : public FireAndForgetCallbackMethodHandlerBase {
private:
  // Rust arguments
...
extern "C" void callback_interface_errorsupport_application_error_reporter_report_error(
  ...
  UniquePtr<FireAndForgetCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodErrorsupportApplicationErrorReporterReportError>(aUniffiHandle, aTypeName, aMessage);
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(std::move(handler), &gUniffiCallbackHandlerApplicationErrorReporter);
}


class CallbackInterfaceMethodErrorsupportApplicationErrorReporterReportBreadcrumb final : public FireAndForgetCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueRustBuffer mMessage{};
...
extern "C" void callback_interface_errorsupport_application_error_reporter_report_breadcrumb(
  ...
  UniquePtr<FireAndForgetCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodErrorsupportApplicationErrorReporterReportBreadcrumb>(aUniffiHandle, aMessage, aModule, aLine, aColumn);
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(std::move(handler), &gUniffiCallbackHandlerApplicationErrorReporter);
}
...
extern "C" void callback_free_errorsupport_application_error_reporter(uint64_t uniffiHandle) {
  // Callback object handles are keys in a map stored in the JS handler. To
  // handle the free call, schedule a fire-and-forget JS call to remove the key.
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(MakeUnique<CallbackFreeHandler>("ApplicationErrorReporter.uniffi_free", uniffiHandle), &gUniffiCallbackHandlerApplicationErrorReporter);
}
...
public:
  ...
  MakeCall(JSContext* aCx, dom::UniFFICallbackHandler* aJsHandler, ErrorResult& aError) override {
    ...
    // Convert each argument
    return aJsHandler->CallAsync(mUniffiHandle.IntoRust(), 0, uniffiArgs, aError);
  }
};
...
extern "C" void callback_interface_uniffi_bindings_tests_test_async_callback_interface_noop(
  ...
  UniquePtr<AsyncCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceNoop>(aUniffiHandle, aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  // Now that everything is set up, schedule the call in the JS main thread.
  AsyncCallbackMethodHandlerBase::ScheduleAsyncCall(std::move(handler), &gUniffiCallbackHandlerTestAsyncCallbackInterface);
}
...
public:
  ...
  MakeCall(JSContext* aCx, dom::UniFFICallbackHandler* aJsHandler, ErrorResult& aError) override {
    ...
    // Convert each argument
    return aJsHandler->CallAsync(mUniffiHandle.IntoRust(), 1, uniffiArgs, aError);
  }
};
...
extern "C" void callback_interface_uniffi_bindings_tests_test_async_callback_interface_get_value(
  ...
  UniquePtr<AsyncCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceGetValue>(aUniffiHandle, aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  // Now that everything is set up, schedule the call in the JS main thread.
  AsyncCallbackMethodHandlerBase::ScheduleAsyncCall(std::move(handler), &gUniffiCallbackHandlerTestAsyncCallbackInterface);
}
...
public:
  ...
  MakeCall(JSContext* aCx, dom::UniFFICallbackHandler* aJsHandler, ErrorResult& aError) override {
    ...
    return aJsHandler->CallAsync(mUniffiHandle.IntoRust(), 2, uniffiArgs, aError);
  }
};
...
extern "C" void callback_interface_uniffi_bindings_tests_test_async_callback_interface_set_value(
  ...
  UniquePtr<AsyncCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceSetValue>(aUniffiHandle, aValue, aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  // Now that everything is set up, schedule the call in the JS main thread.
  AsyncCallbackMethodHandlerBase::ScheduleAsyncCall(std::move(handler), &gUniffiCallbackHandlerTestAsyncCallbackInterface);
}
...
public:
  ...
  MakeCall(JSContext* aCx, dom::UniFFICallbackHandler* aJsHandler, ErrorResult& aError) override {
    ...
    return aJsHandler->CallAsync(mUniffiHandle.IntoRust(), 3, uniffiArgs, aError);
  }
};
...
extern "C" void callback_interface_uniffi_bindings_tests_test_async_callback_interface_throw_if_equal(
  ...
  UniquePtr<AsyncCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestAsyncCallbackInterfaceThrowIfEqual>(aUniffiHandle, aNumbers, aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  // Now that everything is set up, schedule the call in the JS main thread.
  AsyncCallbackMethodHandlerBase::ScheduleAsyncCall(std::move(handler), &gUniffiCallbackHandlerTestAsyncCallbackInterface);
}
...
extern "C" void callback_free_uniffi_bindings_tests_test_async_callback_interface(uint64_t uniffiHandle) {
  // Callback object handles are keys in a map stored in the JS handler. To
  // handle the free call, schedule a fire-and-forget JS call to remove the key.
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(MakeUnique<CallbackFreeHandler>("TestAsyncCallbackInterface.uniffi_free", uniffiHandle), &gUniffiCallbackHandlerTestAsyncCallbackInterface);
}
...
class CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceNoop final : public FireAndForgetCallbackMethodHandlerBase {
private:
  // Rust arguments
...
extern "C" void callback_interface_uniffi_bindings_tests_test_callback_interface_noop(
  ...
  UniquePtr<FireAndForgetCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceNoop>(aUniffiHandle);
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(std::move(handler), &gUniffiCallbackHandlerTestCallbackInterface);
}


class CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceGetValue final : public FireAndForgetCallbackMethodHandlerBase {
private:
  // Rust arguments
...
extern "C" void callback_interface_uniffi_bindings_tests_test_callback_interface_get_value(
  ...
  UniquePtr<FireAndForgetCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceGetValue>(aUniffiHandle);
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(std::move(handler), &gUniffiCallbackHandlerTestCallbackInterface);
}


class CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceSetValue final : public FireAndForgetCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueInt<uint32_t> mValue{};
...
extern "C" void callback_interface_uniffi_bindings_tests_test_callback_interface_set_value(
  ...
  UniquePtr<FireAndForgetCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceSetValue>(aUniffiHandle, aValue);
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(std::move(handler), &gUniffiCallbackHandlerTestCallbackInterface);
}


class CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceThrowIfEqual final : public FireAndForgetCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueRustBuffer mNumbers{};
...
extern "C" void callback_interface_uniffi_bindings_tests_test_callback_interface_throw_if_equal(
  ...
  UniquePtr<FireAndForgetCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestCallbackInterfaceThrowIfEqual>(aUniffiHandle, aNumbers);
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(std::move(handler), &gUniffiCallbackHandlerTestCallbackInterface);
}
...
extern "C" void callback_free_uniffi_bindings_tests_test_callback_interface(uint64_t uniffiHandle) {
  // Callback object handles are keys in a map stored in the JS handler. To
  // handle the free call, schedule a fire-and-forget JS call to remove the key.
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(MakeUnique<CallbackFreeHandler>("TestCallbackInterface.uniffi_free", uniffiHandle), &gUniffiCallbackHandlerTestCallbackInterface);
}
...
extern "C" void callback_interface_uniffi_bindings_tests_async_test_trait_interface_noop(
  ...
  UniquePtr<AsyncCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceNoop>(aUniffiHandle, aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  // Now that everything is set up, schedule the call in the JS main thread.
  AsyncCallbackMethodHandlerBase::ScheduleAsyncCall(std::move(handler), &gUniffiCallbackHandlerAsyncTestTraitInterface);
}
...
extern "C" void callback_interface_uniffi_bindings_tests_async_test_trait_interface_get_value(
  ...
  UniquePtr<AsyncCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceGetValue>(aUniffiHandle, aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  // Now that everything is set up, schedule the call in the JS main thread.
  AsyncCallbackMethodHandlerBase::ScheduleAsyncCall(std::move(handler), &gUniffiCallbackHandlerAsyncTestTraitInterface);
}
...
extern "C" void callback_interface_uniffi_bindings_tests_async_test_trait_interface_set_value(
  ...
  UniquePtr<AsyncCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceSetValue>(aUniffiHandle, aValue, aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  // Now that everything is set up, schedule the call in the JS main thread.
  AsyncCallbackMethodHandlerBase::ScheduleAsyncCall(std::move(handler), &gUniffiCallbackHandlerAsyncTestTraitInterface);
}
...
extern "C" void callback_interface_uniffi_bindings_tests_async_test_trait_interface_throw_if_equal(
  ...
  UniquePtr<AsyncCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsAsyncTestTraitInterfaceThrowIfEqual>(aUniffiHandle, aNumbers, aUniffiForeignFutureCallback, aUniffiForeignFutureCallbackData);
  // Now that everything is set up, schedule the call in the JS main thread.
  AsyncCallbackMethodHandlerBase::ScheduleAsyncCall(std::move(handler), &gUniffiCallbackHandlerAsyncTestTraitInterface);
}
...
extern "C" void callback_free_uniffi_bindings_tests_async_test_trait_interface(uint64_t uniffiHandle) {
  // Callback object handles are keys in a map stored in the JS handler. To
  // handle the free call, schedule a fire-and-forget JS call to remove the key.
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(MakeUnique<CallbackFreeHandler>("AsyncTestTraitInterface.uniffi_free", uniffiHandle), &gUniffiCallbackHandlerAsyncTestTraitInterface);
}
...
class CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceNoop final : public FireAndForgetCallbackMethodHandlerBase {
private:
  // Rust arguments
...
extern "C" void callback_interface_uniffi_bindings_tests_test_trait_interface_noop(
  ...
  UniquePtr<FireAndForgetCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceNoop>(aUniffiHandle);
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(std::move(handler), &gUniffiCallbackHandlerTestTraitInterface);
}


class CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceGetValue final : public FireAndForgetCallbackMethodHandlerBase {
private:
  // Rust arguments
...
extern "C" void callback_interface_uniffi_bindings_tests_test_trait_interface_get_value(
  ...
  UniquePtr<FireAndForgetCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceGetValue>(aUniffiHandle);
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(std::move(handler), &gUniffiCallbackHandlerTestTraitInterface);
}


class CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceSetValue final : public FireAndForgetCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueInt<uint32_t> mValue{};
...
extern "C" void callback_interface_uniffi_bindings_tests_test_trait_interface_set_value(
  ...
  UniquePtr<FireAndForgetCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceSetValue>(aUniffiHandle, aValue);
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(std::move(handler), &gUniffiCallbackHandlerTestTraitInterface);
}


class CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceThrowIfEqual final : public FireAndForgetCallbackMethodHandlerBase {
private:
  // Rust arguments
  FfiValueRustBuffer mNumbers{};
...
extern "C" void callback_interface_uniffi_bindings_tests_test_trait_interface_throw_if_equal(
  ...
  UniquePtr<FireAndForgetCallbackMethodHandlerBase> handler = MakeUnique<CallbackInterfaceMethodUniffiBindingsTestsTestTraitInterfaceThrowIfEqual>(aUniffiHandle, aNumbers);
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(std::move(handler), &gUniffiCallbackHandlerTestTraitInterface);
}
...
extern "C" void callback_free_uniffi_bindings_tests_test_trait_interface(uint64_t uniffiHandle) {
  // Callback object handles are keys in a map stored in the JS handler. To
  // handle the free call, schedule a fire-and-forget JS call to remove the key.
  FireAndForgetCallbackMethodHandlerBase::ScheduleFireAndForgetCall(MakeUnique<CallbackFreeHandler>("TestTraitInterface.uniffi_free", uniffiHandle), &gUniffiCallbackHandlerTestTraitInterface);
}
