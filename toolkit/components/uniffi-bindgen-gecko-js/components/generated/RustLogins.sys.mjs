...
const result = UniFFIScaffolding.callSync(
    10, // uniffi_logins_fn_func_check_canary
...
FfiConverterString.checkType(encryptionKey);
const result = UniFFIScaffolding.callSync(
    11, // uniffi_logins_fn_func_create_canary
    FfiConverterString.lower(text),
    FfiConverterString.lower(encryptionKey),
)
return handleRustResult(
...
const result = UniFFIScaffolding.callSync(
    12, // uniffi_logins_fn_func_create_key
)
return handleRustResult(
    result,
    FfiConverterString.lift.bind(FfiConverterString),
...
const result = UniFFIScaffolding.callSync(
    13, // uniffi_logins_fn_func_create_login_store_with_nss_keymanager
...
const result = UniFFIScaffolding.callSync(
    14, // uniffi_logins_fn_func_create_login_store_with_static_key_manager
    FfiConverterString.lower(path),
...
const result = UniFFIScaffolding.callSync(
    15, // uniffi_logins_fn_func_create_managed_encdec
...
FfiConverterString.checkType(key);
const result = UniFFIScaffolding.callSync(
    16, // uniffi_logins_fn_func_create_static_key_manager
    FfiConverterString.lower(key),
)
return handleRustResult(
    result,
...
export class EncryptorDecryptorImpl extends EncryptorDecryptor {
    ...
    decrypt(
        ...
        const result = UniFFIScaffolding.callSync(
            17, // uniffi_logins_fn_method_encryptordecryptor_decrypt
    ...
    encrypt(
        ...
        const result = UniFFIScaffolding.callSync(
            18, // uniffi_logins_fn_method_encryptordecryptor_encrypt
            FfiConverterTypeEncryptorDecryptor.lowerReceiver(this),
...
export class KeyManagerImpl extends KeyManager {
    ...
    getKey() {
        ...
        const result = UniFFIScaffolding.callSync(
            19, // uniffi_logins_fn_method_keymanager_get_key
...
export class LoginStoreInterface {
     ...
     * @returns {Promise<Array.<BulkResultEntry>>}}
     */
...
export class LoginStore extends LoginStoreInterface {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            20, // uniffi_logins_fn_constructor_loginstore_new
            FfiConverterString.lower(path),
    ...
    add(
        ...
        const result = UniFFIScaffolding.callSync(
            21, // uniffi_logins_fn_method_loginstore_add
    ...
    addMany(
        ...
        const result = UniFFIScaffolding.callSync(
            22, // uniffi_logins_fn_method_loginstore_add_many
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    async addManyWithMeta(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            23, // uniffi_logins_fn_method_loginstore_add_many_with_meta
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    addOrUpdate(
        ...
        FfiConverterTypeLoginEntry.checkType(login);
        const result = UniFFIScaffolding.callSync(
            24, // uniffi_logins_fn_method_loginstore_add_or_update
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterTypeLoginEntry.lower(login),
        )
        return handleRustResult(
    ...
    addWithMeta(
        ...
        const result = UniFFIScaffolding.callSync(
            25, // uniffi_logins_fn_method_loginstore_add_with_meta
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    count() {
        ...
        const result = UniFFIScaffolding.callSync(
            26, // uniffi_logins_fn_method_loginstore_count
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    countByFormActionOrigin(
        ...
        const result = UniFFIScaffolding.callSync(
            27, // uniffi_logins_fn_method_loginstore_count_by_form_action_origin
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    countByOrigin(
        ...
        FfiConverterString.checkType(origin);
        const result = UniFFIScaffolding.callSync(
            28, // uniffi_logins_fn_method_loginstore_count_by_origin
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    delete(
        ...
        FfiConverterString.checkType(id);
        const result = UniFFIScaffolding.callSync(
            29, // uniffi_logins_fn_method_loginstore_delete
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    deleteMany(
        ...
        const result = UniFFIScaffolding.callSync(
            30, // uniffi_logins_fn_method_loginstore_delete_many
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    deleteUndecryptableRecordsForRemoteReplacement() {
        ...
        const result = UniFFIScaffolding.callSync(
            31, // uniffi_logins_fn_method_loginstore_delete_undecryptable_records_for_remote_replacement
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    findLoginToUpdate(
        ...
        const result = UniFFIScaffolding.callSync(
            32, // uniffi_logins_fn_method_loginstore_find_login_to_update
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    get(
        ...
        FfiConverterString.checkType(id);
        const result = UniFFIScaffolding.callSync(
            33, // uniffi_logins_fn_method_loginstore_get
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
        )
        return handleRustResult(
    ...
    getByBaseDomain(
        ...
        const result = UniFFIScaffolding.callSync(
            34, // uniffi_logins_fn_method_loginstore_get_by_base_domain
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    getCheckpoint() {
        ...
        const result = UniFFIScaffolding.callSync(
            35, // uniffi_logins_fn_method_loginstore_get_checkpoint
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    hasLoginsByBaseDomain(
        ...
        FfiConverterString.checkType(baseDomain);
        const result = UniFFIScaffolding.callSync(
            36, // uniffi_logins_fn_method_loginstore_has_logins_by_base_domain
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(baseDomain),
        )
        return handleRustResult(
    ...
    list() {
        ...
        const result = UniFFIScaffolding.callSync(
            38, // uniffi_logins_fn_method_loginstore_list
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    registerWithSyncManager() {
        ...
        const result = UniFFIScaffolding.callSync(
            39, // uniffi_logins_fn_method_loginstore_register_with_sync_manager
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    reset() {
        ...
        const result = UniFFIScaffolding.callSync(
            40, // uniffi_logins_fn_method_loginstore_reset
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async runMaintenance() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            41, // uniffi_logins_fn_method_loginstore_run_maintenance
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    setCheckpoint(
        ...
        const result = UniFFIScaffolding.callSync(
            42, // uniffi_logins_fn_method_loginstore_set_checkpoint
            FfiConverterTypeLoginStore.lowerReceiver(this),
    ...
    shutdown() {
        ...
        const result = UniFFIScaffolding.callSync(
            43, // uniffi_logins_fn_method_loginstore_shutdown
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    touch(
        ...
        FfiConverterString.checkType(id);
        const result = UniFFIScaffolding.callSync(
            44, // uniffi_logins_fn_method_loginstore_touch
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
        )
        return handleRustResult(
    ...
    update(
        ...
        FfiConverterTypeLoginEntry.checkType(login);
        const result = UniFFIScaffolding.callSync(
            45, // uniffi_logins_fn_method_loginstore_update
            FfiConverterTypeLoginStore.lowerReceiver(this),
            FfiConverterString.lower(id),
            FfiConverterTypeLoginEntry.lower(login),
        )
    ...
    wipeLocal() {
        ...
        const result = UniFFIScaffolding.callSync(
            46, // uniffi_logins_fn_method_loginstore_wipe_local
            FfiConverterTypeLoginStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class ManagedEncryptorDecryptor extends ManagedEncryptorDecryptorInterface {
    ...
    static init(
        ...
        FfiConverterTypeKeyManager.checkType(keyManager);
        const result = UniFFIScaffolding.callSync(
            47, // uniffi_logins_fn_constructor_managedencryptordecryptor_new
            FfiConverterTypeKeyManager.lower(keyManager),
        )
        return handleRustResult(
            result,
...
export class NssKeyManager extends NssKeyManagerInterface {
    ...
    static init(
        ...
        FfiConverterTypePrimaryPasswordAuthenticator.checkType(primaryPasswordAuthenticator);
        const result = UniFFIScaffolding.callSync(
            48, // uniffi_logins_fn_constructor_nsskeymanager_new
            FfiConverterTypePrimaryPasswordAuthenticator.lower(primaryPasswordAuthenticator),
        )
        return handleRustResult(
            result,
    ...
    intoDynKeyManager() {
        ...
        const result = UniFFIScaffolding.callSync(
            49, // uniffi_logins_fn_method_nsskeymanager_into_dyn_key_manager
...
export class PrimaryPasswordAuthenticatorImpl extends PrimaryPasswordAuthenticator {
    ...
    async getPrimaryPassword() {
        ...
        const result = await UniFFIScaffolding.callAsync(
            50, // uniffi_logins_fn_method_primarypasswordauthenticator_get_primary_password
    ...
    async onAuthenticationSuccess() {
        ...
        const result = await UniFFIScaffolding.callAsync(
            51, // uniffi_logins_fn_method_primarypasswordauthenticator_on_authentication_success
            FfiConverterTypePrimaryPasswordAuthenticator.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async onAuthenticationFailure() {
        ...
        const result = await UniFFIScaffolding.callAsync(
            52, // uniffi_logins_fn_method_primarypasswordauthenticator_on_authentication_failure
            FfiConverterTypePrimaryPasswordAuthenticator.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class StaticKeyManager extends StaticKeyManagerInterface {
    ...
    static init(
        ...
        FfiConverterString.checkType(key);
        const result = UniFFIScaffolding.callSync(
            53, // uniffi_logins_fn_constructor_statickeymanager_new
            FfiConverterString.lower(key),
        )
        return handleRustResult(
            result,
