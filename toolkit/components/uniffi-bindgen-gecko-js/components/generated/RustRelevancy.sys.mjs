...
const result = UniFFIScaffolding.callSync(
    11, // uniffi_relevancy_fn_func_score
...
export class RelevancyStore extends RelevancyStoreInterface {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            153, // uniffi_relevancy_fn_constructor_relevancystore_new
    ...
    async banditInit(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            154, // uniffi_relevancy_fn_method_relevancystore_bandit_init
    ...
    async banditSelect(
        ...
        FfiConverterSequenceString.checkType(arms);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            155, // uniffi_relevancy_fn_method_relevancystore_bandit_select
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
            FfiConverterString.lower(bandit),
            FfiConverterSequenceString.lower(arms),
        )
    ...
    async banditUpdate(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            156, // uniffi_relevancy_fn_method_relevancystore_bandit_update
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
            FfiConverterString.lower(bandit),
    ...
    close() {
        ...
        const result = UniFFIScaffolding.callSync(
            157, // uniffi_relevancy_fn_method_relevancystore_close
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async ensureInterestDataPopulated() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            158, // uniffi_relevancy_fn_method_relevancystore_ensure_interest_data_populated
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async getBanditData(
        ...
        FfiConverterString.checkType(arm);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            159, // uniffi_relevancy_fn_method_relevancystore_get_bandit_data
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
            FfiConverterString.lower(bandit),
            FfiConverterString.lower(arm),
        )
    ...
    async ingest(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            160, // uniffi_relevancy_fn_method_relevancystore_ingest
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
    ...
    interrupt() {
        ...
        const result = UniFFIScaffolding.callSync(
            161, // uniffi_relevancy_fn_method_relevancystore_interrupt
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async userInterestVector() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            162, // uniffi_relevancy_fn_method_relevancystore_user_interest_vector
            FfiConverterTypeRelevancyStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
