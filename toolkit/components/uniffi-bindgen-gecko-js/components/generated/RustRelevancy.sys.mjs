...
const result = UniFFIScaffolding.callSync(
    3, // uniffi_relevancy_fn_func_score
...
export class RelevancyStore {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            4, // uniffi_relevancy_fn_constructor_relevancystore_new
    ...
    async banditInit(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            5, // uniffi_relevancy_fn_method_relevancystore_bandit_init
    ...
    async banditSelect(
        ...
        FfiConverterSequenceString.checkType(arms);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            6, // uniffi_relevancy_fn_method_relevancystore_bandit_select
            FfiConverterTypeRelevancyStore.lower(this),
            FfiConverterString.lower(bandit),
            FfiConverterSequenceString.lower(arms),
        )
    ...
    async banditUpdate(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            7, // uniffi_relevancy_fn_method_relevancystore_bandit_update
            FfiConverterTypeRelevancyStore.lower(this),
            FfiConverterString.lower(bandit),
    ...
    close() {
        ...
        const result = UniFFIScaffolding.callSync(
            8, // uniffi_relevancy_fn_method_relevancystore_close
            FfiConverterTypeRelevancyStore.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async ensureInterestDataPopulated() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            9, // uniffi_relevancy_fn_method_relevancystore_ensure_interest_data_populated
            FfiConverterTypeRelevancyStore.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async getBanditData(
        ...
        FfiConverterString.checkType(arm);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            10, // uniffi_relevancy_fn_method_relevancystore_get_bandit_data
            FfiConverterTypeRelevancyStore.lower(this),
            FfiConverterString.lower(bandit),
            FfiConverterString.lower(arm),
        )
    ...
    async ingest(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            11, // uniffi_relevancy_fn_method_relevancystore_ingest
            FfiConverterTypeRelevancyStore.lower(this),
    ...
    interrupt() {
        ...
        const result = UniFFIScaffolding.callSync(
            12, // uniffi_relevancy_fn_method_relevancystore_interrupt
            FfiConverterTypeRelevancyStore.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async userInterestVector() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            13, // uniffi_relevancy_fn_method_relevancystore_user_interest_vector
            FfiConverterTypeRelevancyStore.lower(this),
        )
        return handleRustResult(
            result,
