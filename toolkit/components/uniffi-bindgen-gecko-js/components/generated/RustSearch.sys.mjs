...
export class SearchEngineSelector {
    ...
    static init() {
        ...
        const result = UniFFIScaffolding.callSync(
            27, // uniffi_search_fn_constructor_searchengineselector_new
        )
    ...
    clearSearchConfig() {
        ...
        const result = UniFFIScaffolding.callSync(
            28, // uniffi_search_fn_method_searchengineselector_clear_search_config
    ...
    filterEngineConfiguration(
        ...
        const result = UniFFIScaffolding.callSync(
            29, // uniffi_search_fn_method_searchengineselector_filter_engine_configuration
            FfiConverterTypeSearchEngineSelector.lower(this),
    ...
    setConfigOverrides(
        ...
        const result = UniFFIScaffolding.callSync(
            30, // uniffi_search_fn_method_searchengineselector_set_config_overrides
            FfiConverterTypeSearchEngineSelector.lower(this),
    ...
    setSearchConfig(
        ...
        const result = UniFFIScaffolding.callSync(
            31, // uniffi_search_fn_method_searchengineselector_set_search_config
            FfiConverterTypeSearchEngineSelector.lower(this),
    ...
    async useRemoteSettingsServer(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            32, // uniffi_search_fn_method_searchengineselector_use_remote_settings_server
            FfiConverterTypeSearchEngineSelector.lower(this),
