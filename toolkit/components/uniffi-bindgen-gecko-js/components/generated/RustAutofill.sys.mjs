...
export class AddressesBridgedEngine extends AddressesBridgedEngineInterface {
    ...
    async apply(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            38, // uniffi_autofill_fn_method_addressesbridgedengine_apply
    ...
    async ensureCurrentSyncId(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            39, // uniffi_autofill_fn_method_addressesbridgedengine_ensure_current_sync_id
            FfiConverterTypeAddressesBridgedEngine.lowerReceiver(this),
    ...
    async lastSync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            40, // uniffi_autofill_fn_method_addressesbridgedengine_last_sync
            FfiConverterTypeAddressesBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async reset() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            41, // uniffi_autofill_fn_method_addressesbridgedengine_reset
            FfiConverterTypeAddressesBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async resetSyncId() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            42, // uniffi_autofill_fn_method_addressesbridgedengine_reset_sync_id
            FfiConverterTypeAddressesBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async setUploaded(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            43, // uniffi_autofill_fn_method_addressesbridgedengine_set_uploaded
            FfiConverterTypeAddressesBridgedEngine.lowerReceiver(this),
    ...
    async storeIncoming(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            44, // uniffi_autofill_fn_method_addressesbridgedengine_store_incoming
            FfiConverterTypeAddressesBridgedEngine.lowerReceiver(this),
    ...
    async syncFinished() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            45, // uniffi_autofill_fn_method_addressesbridgedengine_sync_finished
            FfiConverterTypeAddressesBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async syncId() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            46, // uniffi_autofill_fn_method_addressesbridgedengine_sync_id
            FfiConverterTypeAddressesBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async syncStarted() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            47, // uniffi_autofill_fn_method_addressesbridgedengine_sync_started
            FfiConverterTypeAddressesBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async wipe() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            48, // uniffi_autofill_fn_method_addressesbridgedengine_wipe
            FfiConverterTypeAddressesBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class Store extends StoreInterface {
    ...
    static async init(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            49, // uniffi_autofill_fn_constructor_store_new
    ...
    async addAddress(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            50, // uniffi_autofill_fn_method_store_add_address
    ...
    async addAddressWithMeta(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            51, // uniffi_autofill_fn_method_store_add_address_with_meta
            FfiConverterTypeStore.lowerReceiver(this),
    ...
    async addCreditCard(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            52, // uniffi_autofill_fn_method_store_add_credit_card
            FfiConverterTypeStore.lowerReceiver(this),
    ...
    async addManyAddressTombstones(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            53, // uniffi_autofill_fn_method_store_add_many_address_tombstones
            FfiConverterTypeStore.lowerReceiver(this),
    ...
    async addManyAddressesWithMeta(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            54, // uniffi_autofill_fn_method_store_add_many_addresses_with_meta
            FfiConverterTypeStore.lowerReceiver(this),
    ...
    async addPassport(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            55, // uniffi_autofill_fn_method_store_add_passport
            FfiConverterTypeStore.lowerReceiver(this),
    ...
    async addressesBridgedEngine() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            56, // uniffi_autofill_fn_method_store_addresses_bridged_engine
            FfiConverterTypeStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async countAllAddresses() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            57, // uniffi_autofill_fn_method_store_count_all_addresses
            FfiConverterTypeStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async countAllCreditCards() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            58, // uniffi_autofill_fn_method_store_count_all_credit_cards
            FfiConverterTypeStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async countAllPassports() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            59, // uniffi_autofill_fn_method_store_count_all_passports
            FfiConverterTypeStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async deleteAddress(
        ...
        FfiConverterString.checkType(guid);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            60, // uniffi_autofill_fn_method_store_delete_address
            FfiConverterTypeStore.lowerReceiver(this),
    ...
    async deleteAllAddresses() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            61, // uniffi_autofill_fn_method_store_delete_all_addresses
            FfiConverterTypeStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async deleteCreditCard(
        ...
        FfiConverterString.checkType(guid);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            62, // uniffi_autofill_fn_method_store_delete_credit_card
            FfiConverterTypeStore.lowerReceiver(this),
            FfiConverterString.lower(guid),
        )
        return handleRustResult(
    ...
    async deletePassport(
        ...
        FfiConverterString.checkType(guid);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            63, // uniffi_autofill_fn_method_store_delete_passport
            FfiConverterTypeStore.lowerReceiver(this),
            FfiConverterString.lower(guid),
        )
        return handleRustResult(
    ...
    async getAddress(
        ...
        FfiConverterString.checkType(guid);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            64, // uniffi_autofill_fn_method_store_get_address
            FfiConverterTypeStore.lowerReceiver(this),
            FfiConverterString.lower(guid),
        )
        return handleRustResult(
    ...
    async getAllAddresses() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            65, // uniffi_autofill_fn_method_store_get_all_addresses
            FfiConverterTypeStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async getAllCreditCards() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            66, // uniffi_autofill_fn_method_store_get_all_credit_cards
            FfiConverterTypeStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async getAllPassports() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            67, // uniffi_autofill_fn_method_store_get_all_passports
            FfiConverterTypeStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async getCreditCard(
        ...
        FfiConverterString.checkType(guid);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            68, // uniffi_autofill_fn_method_store_get_credit_card
            FfiConverterTypeStore.lowerReceiver(this),
            FfiConverterString.lower(guid),
        )
        return handleRustResult(
    ...
    async getPassport(
        ...
        FfiConverterString.checkType(guid);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            69, // uniffi_autofill_fn_method_store_get_passport
            FfiConverterTypeStore.lowerReceiver(this),
            FfiConverterString.lower(guid),
        )
        return handleRustResult(
    ...
    async registerWithSyncManager() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            70, // uniffi_autofill_fn_method_store_register_with_sync_manager
            FfiConverterTypeStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async runMaintenance() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            71, // uniffi_autofill_fn_method_store_run_maintenance
            FfiConverterTypeStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async scrubEncryptedData() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            72, // uniffi_autofill_fn_method_store_scrub_encrypted_data
            FfiConverterTypeStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async scrubUndecryptableCreditCardDataForRemoteReplacement(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            73, // uniffi_autofill_fn_method_store_scrub_undecryptable_credit_card_data_for_remote_replacement
            FfiConverterTypeStore.lowerReceiver(this),
    ...
    async shutdown() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            74, // uniffi_autofill_fn_method_store_shutdown
            FfiConverterTypeStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async touchAddress(
        ...
        FfiConverterString.checkType(guid);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            75, // uniffi_autofill_fn_method_store_touch_address
            FfiConverterTypeStore.lowerReceiver(this),
            FfiConverterString.lower(guid),
        )
        return handleRustResult(
    ...
    async touchCreditCard(
        ...
        FfiConverterString.checkType(guid);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            76, // uniffi_autofill_fn_method_store_touch_credit_card
            FfiConverterTypeStore.lowerReceiver(this),
            FfiConverterString.lower(guid),
        )
        return handleRustResult(
    ...
    async touchPassport(
        ...
        FfiConverterString.checkType(guid);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            77, // uniffi_autofill_fn_method_store_touch_passport
            FfiConverterTypeStore.lowerReceiver(this),
            FfiConverterString.lower(guid),
        )
        return handleRustResult(
    ...
    async updateAddress(
        ...
        FfiConverterTypeUpdatableAddressFields.checkType(a);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            78, // uniffi_autofill_fn_method_store_update_address
            FfiConverterTypeStore.lowerReceiver(this),
            FfiConverterString.lower(guid),
            FfiConverterTypeUpdatableAddressFields.lower(a),
        )
    ...
    async updateAddressWithMeta(
        ...
        FfiConverterTypeUpdatableAddressFieldsWithMeta.checkType(entryWithMeta);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            79, // uniffi_autofill_fn_method_store_update_address_with_meta
            FfiConverterTypeStore.lowerReceiver(this),
            FfiConverterTypeUpdatableAddressFieldsWithMeta.lower(entryWithMeta),
        )
        return handleRustResult(
    ...
    async updateCreditCard(
        ...
        FfiConverterTypeUpdatableCreditCardFields.checkType(cc);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            80, // uniffi_autofill_fn_method_store_update_credit_card
            FfiConverterTypeStore.lowerReceiver(this),
            FfiConverterString.lower(guid),
            FfiConverterTypeUpdatableCreditCardFields.lower(cc),
        )
    ...
    async updatePassport(
        ...
        FfiConverterTypeUpdatablePassportFields.checkType(p);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            81, // uniffi_autofill_fn_method_store_update_passport
            FfiConverterTypeStore.lowerReceiver(this),
            FfiConverterString.lower(guid),
            FfiConverterTypeUpdatablePassportFields.lower(p),
        )
