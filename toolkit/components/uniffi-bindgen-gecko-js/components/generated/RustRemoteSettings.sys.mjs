...
export class RemoteSettingsClient extends RemoteSettingsClientInterface {
    ...
    async collectionName() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            163, // uniffi_remote_settings_fn_method_remotesettingsclient_collection_name
    ...
    async getAttachment(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            164, // uniffi_remote_settings_fn_method_remotesettingsclient_get_attachment
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
    ...
    async getLastModifiedTimestamp() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            165, // uniffi_remote_settings_fn_method_remotesettingsclient_get_last_modified_timestamp
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async getRecords(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            166, // uniffi_remote_settings_fn_method_remotesettingsclient_get_records
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
    ...
    async getRecordsMap(
        ...
        FfiConverterBoolean.checkType(syncIfEmpty);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            167, // uniffi_remote_settings_fn_method_remotesettingsclient_get_records_map
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
            FfiConverterBoolean.lower(syncIfEmpty),
        )
        return handleRustResult(
    ...
    async resetStorage() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            168, // uniffi_remote_settings_fn_method_remotesettingsclient_reset_storage
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async shutdown() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            169, // uniffi_remote_settings_fn_method_remotesettingsclient_shutdown
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async sync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            170, // uniffi_remote_settings_fn_method_remotesettingsclient_sync
            FfiConverterTypeRemoteSettingsClient.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class RemoteSettingsService extends RemoteSettingsServiceInterface {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            171, // uniffi_remote_settings_fn_constructor_remotesettingsservice_new
    ...
    clientUrl() {
        ...
        const result = UniFFIScaffolding.callSync(
            172, // uniffi_remote_settings_fn_method_remotesettingsservice_client_url
    ...
    async makeClient(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            173, // uniffi_remote_settings_fn_method_remotesettingsservice_make_client
            FfiConverterTypeRemoteSettingsService.lowerReceiver(this),
    ...
    async sync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            174, // uniffi_remote_settings_fn_method_remotesettingsservice_sync
            FfiConverterTypeRemoteSettingsService.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async updateConfig(
        ...
        FfiConverterTypeRemoteSettingsConfig.checkType(config);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            175, // uniffi_remote_settings_fn_method_remotesettingsservice_update_config
            FfiConverterTypeRemoteSettingsService.lowerReceiver(this),
            FfiConverterTypeRemoteSettingsConfig.lower(config),
        )
        return handleRustResult(
