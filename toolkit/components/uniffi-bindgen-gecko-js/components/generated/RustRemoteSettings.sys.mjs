    ...
    constructor(
        {
            ...
            customTargetingAttributes: undefined
        }
    ) {
        try {
        ...
        try {
            FfiConverterOptionalInt64.checkType(installationDate)
        } catch (e) {
            if (e instanceof UniFFITypeError) {
...
export class FfiConverterTypeRemoteSettingsContext extends FfiConverterArrayBuffer {
    static read(dataStream) {
        return new RemoteSettingsContext({
            ...
            installationDate: FfiConverterOptionalInt64.read(dataStream),
    ...
    static write(dataStream, value) {
        ...
        FfiConverterOptionalInt64.write(dataStream, value.installationDate);
    ...
    static computeSize(value) {
        ...
        totalSize += FfiConverterOptionalInt64.computeSize(value.installationDate);
    ...
    static checkType(value) {
        ...
        try {
            FfiConverterOptionalInt64.checkType(value.installationDate);
        } catch (e) {
            if (e instanceof UniFFITypeError) {
                e.addItemDescriptionPart(".installationDate");
            }
...
export class RemoteSettingsClient {
    ...
    async sync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            22, // uniffi_remote_settings_fn_method_remotesettingsclient_sync
            FfiConverterTypeRemoteSettingsClient.lower(this),
        )
        return handleRustResult(
            result,
...
export class RemoteSettingsService {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            23, // uniffi_remote_settings_fn_constructor_remotesettingsservice_new
    ...
    async makeClient(
        ...
        FfiConverterString.checkType(collectionName);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            24, // uniffi_remote_settings_fn_method_remotesettingsservice_make_client
    ...
    async sync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            25, // uniffi_remote_settings_fn_method_remotesettingsservice_sync
            FfiConverterTypeRemoteSettingsService.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async updateConfig(
        ...
        FfiConverterTypeRemoteSettingsConfig2.checkType(config);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            26, // uniffi_remote_settings_fn_method_remotesettingsservice_update_config
            FfiConverterTypeRemoteSettingsService.lower(this),
            FfiConverterTypeRemoteSettingsConfig2.lower(config),
        )
        return handleRustResult(
