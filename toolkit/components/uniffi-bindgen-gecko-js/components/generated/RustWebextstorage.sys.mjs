...
export class WebExtStorageBridgedEngine {
    ...
    async apply() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            78, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_apply
    ...
    async ensureCurrentSyncId(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            79, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_ensure_current_sync_id
            FfiConverterTypeWebExtStorageBridgedEngine.lower(this),
    ...
    async lastSync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            80, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_last_sync
            FfiConverterTypeWebExtStorageBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async prepareForSync(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            81, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_prepare_for_sync
            FfiConverterTypeWebExtStorageBridgedEngine.lower(this),
    ...
    async reset() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            82, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_reset
            FfiConverterTypeWebExtStorageBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async resetSyncId() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            83, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_reset_sync_id
            FfiConverterTypeWebExtStorageBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async setLastSync(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            84, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_set_last_sync
            FfiConverterTypeWebExtStorageBridgedEngine.lower(this),
    ...
    async setUploaded(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            85, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_set_uploaded
            FfiConverterTypeWebExtStorageBridgedEngine.lower(this),
    ...
    async storeIncoming(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            86, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_store_incoming
            FfiConverterTypeWebExtStorageBridgedEngine.lower(this),
    ...
    async syncFinished() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            87, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_sync_finished
            FfiConverterTypeWebExtStorageBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async syncId() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            88, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_sync_id
            FfiConverterTypeWebExtStorageBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async syncStarted() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            89, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_sync_started
            FfiConverterTypeWebExtStorageBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async wipe() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            90, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_wipe
            FfiConverterTypeWebExtStorageBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
...
export class WebExtStorageStore {
    ...
    static init(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            91, // uniffi_webext_storage_fn_constructor_webextstoragestore_new
    ...
    async bridgedEngine() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            92, // uniffi_webext_storage_fn_method_webextstoragestore_bridged_engine
    ...
    async clear(
        ...
        FfiConverterString.checkType(extId);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            93, // uniffi_webext_storage_fn_method_webextstoragestore_clear
            FfiConverterTypeWebExtStorageStore.lower(this),
    ...
    async close() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            94, // uniffi_webext_storage_fn_method_webextstoragestore_close
            FfiConverterTypeWebExtStorageStore.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async get(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            95, // uniffi_webext_storage_fn_method_webextstoragestore_get
            FfiConverterTypeWebExtStorageStore.lower(this),
            FfiConverterString.lower(extId),
    ...
    async getBytesInUse(
        ...
        FfiConverterTypeJsonValue.checkType(keys);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            96, // uniffi_webext_storage_fn_method_webextstoragestore_get_bytes_in_use
            FfiConverterTypeWebExtStorageStore.lower(this),
            FfiConverterString.lower(extId),
            FfiConverterTypeJsonValue.lower(keys),
        )
    ...
    async getSyncedChanges() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            97, // uniffi_webext_storage_fn_method_webextstoragestore_get_synced_changes
            FfiConverterTypeWebExtStorageStore.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async remove(
        ...
        FfiConverterTypeJsonValue.checkType(keys);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            98, // uniffi_webext_storage_fn_method_webextstoragestore_remove
            FfiConverterTypeWebExtStorageStore.lower(this),
            FfiConverterString.lower(extId),
            FfiConverterTypeJsonValue.lower(keys),
        )
    ...
    async set(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            99, // uniffi_webext_storage_fn_method_webextstoragestore_set
            FfiConverterTypeWebExtStorageStore.lower(this),
            FfiConverterString.lower(extId),
