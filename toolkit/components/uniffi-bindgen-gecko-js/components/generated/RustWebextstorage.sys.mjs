...
export class WebExtStorageBridgedEngine extends WebExtStorageBridgedEngineInterface {
    ...
    async apply(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            234, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_apply
    ...
    async ensureCurrentSyncId(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            235, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_ensure_current_sync_id
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
    ...
    async lastSync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            236, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_last_sync
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async reset() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            237, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_reset
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async resetLastSync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            238, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_reset_last_sync
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async resetSyncId() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            239, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_reset_sync_id
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async setUploaded(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            240, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_set_uploaded
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
            FfiConverterInt64.lower(serverModifiedMillis),
    ...
    async storeIncoming(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            241, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_store_incoming
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
    ...
    async syncFinished() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            242, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_sync_finished
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async syncId() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            243, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_sync_id
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async syncStarted() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            244, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_sync_started
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async wipe() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            245, // uniffi_webext_storage_fn_method_webextstoragebridgedengine_wipe
            FfiConverterTypeWebExtStorageBridgedEngine.lowerReceiver(this),
        )
        return handleRustResult(
            result,
...
export class WebExtStorageStore extends WebExtStorageStoreInterface {
    ...
    static async init(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            246, // uniffi_webext_storage_fn_constructor_webextstoragestore_new
    ...
    async bridgedEngine() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            247, // uniffi_webext_storage_fn_method_webextstoragestore_bridged_engine
    ...
    async clear(
        ...
        FfiConverterString.checkType(extId);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            248, // uniffi_webext_storage_fn_method_webextstoragestore_clear
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
    ...
    async close() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            249, // uniffi_webext_storage_fn_method_webextstoragestore_close
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async get(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            250, // uniffi_webext_storage_fn_method_webextstoragestore_get
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
            FfiConverterString.lower(extId),
    ...
    async getBytesInUse(
        ...
        FfiConverterTypeJsonValue.checkType(keys);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            251, // uniffi_webext_storage_fn_method_webextstoragestore_get_bytes_in_use
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
            FfiConverterString.lower(extId),
            FfiConverterTypeJsonValue.lower(keys),
        )
    ...
    async getKeys(
        ...
        FfiConverterString.checkType(extId);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            252, // uniffi_webext_storage_fn_method_webextstoragestore_get_keys
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
            FfiConverterString.lower(extId),
        )
        return handleRustResult(
    ...
    async getSyncedChanges() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            253, // uniffi_webext_storage_fn_method_webextstoragestore_get_synced_changes
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async remove(
        ...
        FfiConverterTypeJsonValue.checkType(keys);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            254, // uniffi_webext_storage_fn_method_webextstoragestore_remove
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
            FfiConverterString.lower(extId),
            FfiConverterTypeJsonValue.lower(keys),
        )
    ...
    async set(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            255, // uniffi_webext_storage_fn_method_webextstoragestore_set
            FfiConverterTypeWebExtStorageStore.lowerReceiver(this),
            FfiConverterString.lower(extId),
