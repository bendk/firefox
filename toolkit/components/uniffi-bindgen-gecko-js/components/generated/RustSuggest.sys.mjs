...
const result = UniFFIScaffolding.callSync(
    33, // uniffi_suggest_fn_func_raw_suggestion_url_matches
...
export class SuggestionProviderConstraints {
    constructor(
        {
            exposureSuggestionTypes= null, 
            ampAlternativeMatching= null
        } = {
            exposureSuggestionTypes: undefined, 
...
export class SuggestStore {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            34, // uniffi_suggest_fn_constructor_suggeststore_new
    ...
    async clear() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            35, // uniffi_suggest_fn_method_suggeststore_clear
    ...
    async clearDismissedSuggestions() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            36, // uniffi_suggest_fn_method_suggeststore_clear_dismissed_suggestions
            FfiConverterTypeSuggestStore.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async dismissSuggestion(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            37, // uniffi_suggest_fn_method_suggeststore_dismiss_suggestion
            FfiConverterTypeSuggestStore.lower(this),
    ...
    async fetchGeonames(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            38, // uniffi_suggest_fn_method_suggeststore_fetch_geonames
            FfiConverterTypeSuggestStore.lower(this),
    ...
    async fetchGlobalConfig() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            39, // uniffi_suggest_fn_method_suggeststore_fetch_global_config
            FfiConverterTypeSuggestStore.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async fetchProviderConfig(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            40, // uniffi_suggest_fn_method_suggeststore_fetch_provider_config
            FfiConverterTypeSuggestStore.lower(this),
    ...
    async ingest(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            41, // uniffi_suggest_fn_method_suggeststore_ingest
            FfiConverterTypeSuggestStore.lower(this),
    ...
    interrupt(
        ...
        const result = UniFFIScaffolding.callSync(
            42, // uniffi_suggest_fn_method_suggeststore_interrupt
            FfiConverterTypeSuggestStore.lower(this),
    ...
    async query(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            43, // uniffi_suggest_fn_method_suggeststore_query
            FfiConverterTypeSuggestStore.lower(this),
    ...
    async queryWithMetrics(
        ...
        FfiConverterTypeSuggestionQuery.checkType(query);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            44, // uniffi_suggest_fn_method_suggeststore_query_with_metrics
            FfiConverterTypeSuggestStore.lower(this),
            FfiConverterTypeSuggestionQuery.lower(query),
        )
        return handleRustResult(
...
export class SuggestStoreBuilder {
    ...
    static init() {
        ...
        const result = UniFFIScaffolding.callSync(
            45, // uniffi_suggest_fn_constructor_suggeststorebuilder_new
        )
        return handleRustResult(
            result,
    ...
    build() {
        ...
        const result = UniFFIScaffolding.callSync(
            46, // uniffi_suggest_fn_method_suggeststorebuilder_build
    ...
    async cachePath(
        ...
        FfiConverterString.checkType(path);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            47, // uniffi_suggest_fn_method_suggeststorebuilder_cache_path
            FfiConverterTypeSuggestStoreBuilder.lower(this),
            FfiConverterString.lower(path),
        )
        return handleRustResult(
    ...
    dataPath(
        ...
        FfiConverterString.checkType(path);
        const result = UniFFIScaffolding.callSync(
            48, // uniffi_suggest_fn_method_suggeststorebuilder_data_path
            FfiConverterTypeSuggestStoreBuilder.lower(this),
            FfiConverterString.lower(path),
        )
        return handleRustResult(
    ...
    loadExtension(
        ...
        const result = UniFFIScaffolding.callSync(
            49, // uniffi_suggest_fn_method_suggeststorebuilder_load_extension
            FfiConverterTypeSuggestStoreBuilder.lower(this),
    ...
    remoteSettingsBucketName(
        ...
        const result = UniFFIScaffolding.callSync(
            50, // uniffi_suggest_fn_method_suggeststorebuilder_remote_settings_bucket_name
            FfiConverterTypeSuggestStoreBuilder.lower(this),
    ...
    remoteSettingsServer(
        ...
        const result = UniFFIScaffolding.callSync(
            51, // uniffi_suggest_fn_method_suggeststorebuilder_remote_settings_server
            FfiConverterTypeSuggestStoreBuilder.lower(this),
    ...
    remoteSettingsService(
        ...
        const result = UniFFIScaffolding.callSync(
            52, // uniffi_suggest_fn_method_suggeststorebuilder_remote_settings_service
            FfiConverterTypeSuggestStoreBuilder.lower(this),
