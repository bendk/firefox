...
export class RemoteCommandStore {
    ...
    async addRemoteCommand(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            53, // uniffi_tabs_fn_method_remotecommandstore_add_remote_command
    ...
    async addRemoteCommandAt(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            54, // uniffi_tabs_fn_method_remotecommandstore_add_remote_command_at
            FfiConverterTypeRemoteCommandStore.lower(this),
            FfiConverterString.lower(deviceId),
            FfiConverterTypeRemoteCommand.lower(command),
    ...
    async getUnsentCommands() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            55, // uniffi_tabs_fn_method_remotecommandstore_get_unsent_commands
            FfiConverterTypeRemoteCommandStore.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async removeRemoteCommand(
        ...
        FfiConverterTypeRemoteCommand.checkType(command);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            56, // uniffi_tabs_fn_method_remotecommandstore_remove_remote_command
            FfiConverterTypeRemoteCommandStore.lower(this),
            FfiConverterString.lower(deviceId),
            FfiConverterTypeRemoteCommand.lower(command),
        )
    ...
    async setPendingCommandSent(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            57, // uniffi_tabs_fn_method_remotecommandstore_set_pending_command_sent
            FfiConverterTypeRemoteCommandStore.lower(this),
...
export class TabsBridgedEngine {
    ...
    async apply() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            58, // uniffi_tabs_fn_method_tabsbridgedengine_apply
    ...
    async ensureCurrentSyncId(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            59, // uniffi_tabs_fn_method_tabsbridgedengine_ensure_current_sync_id
            FfiConverterTypeTabsBridgedEngine.lower(this),
    ...
    async lastSync() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            60, // uniffi_tabs_fn_method_tabsbridgedengine_last_sync
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async prepareForSync(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            61, // uniffi_tabs_fn_method_tabsbridgedengine_prepare_for_sync
            FfiConverterTypeTabsBridgedEngine.lower(this),
    ...
    async reset() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            62, // uniffi_tabs_fn_method_tabsbridgedengine_reset
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async resetSyncId() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            63, // uniffi_tabs_fn_method_tabsbridgedengine_reset_sync_id
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async setLastSync(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            64, // uniffi_tabs_fn_method_tabsbridgedengine_set_last_sync
            FfiConverterTypeTabsBridgedEngine.lower(this),
    ...
    async setUploaded(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            65, // uniffi_tabs_fn_method_tabsbridgedengine_set_uploaded
            FfiConverterTypeTabsBridgedEngine.lower(this),
    ...
    async storeIncoming(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            66, // uniffi_tabs_fn_method_tabsbridgedengine_store_incoming
            FfiConverterTypeTabsBridgedEngine.lower(this),
    ...
    async syncFinished() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            67, // uniffi_tabs_fn_method_tabsbridgedengine_sync_finished
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async syncId() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            68, // uniffi_tabs_fn_method_tabsbridgedengine_sync_id
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async syncStarted() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            69, // uniffi_tabs_fn_method_tabsbridgedengine_sync_started
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async wipe() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            70, // uniffi_tabs_fn_method_tabsbridgedengine_wipe
            FfiConverterTypeTabsBridgedEngine.lower(this),
        )
        return handleRustResult(
            result,
...
export class TabsStore {
    ...
    static init(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            71, // uniffi_tabs_fn_constructor_tabsstore_new
    ...
    async bridgedEngine() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            72, // uniffi_tabs_fn_method_tabsstore_bridged_engine
    ...
    async closeConnection() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            73, // uniffi_tabs_fn_method_tabsstore_close_connection
            FfiConverterTypeTabsStore.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async getAll() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            74, // uniffi_tabs_fn_method_tabsstore_get_all
            FfiConverterTypeTabsStore.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async newRemoteCommandStore() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            75, // uniffi_tabs_fn_method_tabsstore_new_remote_command_store
            FfiConverterTypeTabsStore.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async registerWithSyncManager() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            76, // uniffi_tabs_fn_method_tabsstore_register_with_sync_manager
            FfiConverterTypeTabsStore.lower(this),
        )
        return handleRustResult(
            result,
    ...
    async setLocalTabs(
        ...
        FfiConverterSequenceTypeRemoteTabRecord.checkType(remoteTabs);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            77, // uniffi_tabs_fn_method_tabsstore_set_local_tabs
            FfiConverterTypeTabsStore.lower(this),
