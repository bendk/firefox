...
const result = UniFFIScaffolding.callSync(
    337, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_custom_type
...
const result = UniFFIScaffolding.callSync(
    338, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_enum
...
const result = UniFFIScaffolding.callSync(
    339, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_interface
...
const result = UniFFIScaffolding.callSync(
    340, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_record
