...
const result = UniFFIScaffolding.callSync(
    253, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_custom_type
...
const result = UniFFIScaffolding.callSync(
    254, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_enum
...
const result = UniFFIScaffolding.callSync(
    255, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_interface
...
const result = UniFFIScaffolding.callSync(
    256, // uniffi_uniffi_bindings_tests_external_types_fn_func_roundtrip_ext_record
